...
function graduates (students) {
    ...
    for (var i in students) {
      ...
      if (result[kelas] === undefined && students[i].score > 75) {
        
      // MENSORTIR STUDENT YANG GAGAL
      var lulus = {};
      ...
      // MENAMBAHKAN STUDENT LAIN YANG LULUS KE DALAM KELAS
      var subLulus = {};
        subLulus.name = students[i].name;
        subLulus.score = students[i].score;
        result[kelas].push (subLulus);
      }
    }
    return result;
  }
